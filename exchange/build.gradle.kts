...
//    implementation("ru.tinkoff.piapi:java-sdk-core:1.0-M2")
//    implementation("ru.tinkoff.piapi:java-sdk:1.0-M2")
    implementation("ru.tinkoff.piapi:java-sdk-core:1.0-SNAPSHOT")
